...
void met_pt_plotter()
{
  ...
  THStack* stack_hist = new THStack("met_pt_stack", "Met Momentum Histograms");
  ...
  stack_hist->Draw();
  stack_hist->SetName("met_pt plot");
  stack_hist->SetTitle("Plot of Met Momentum");
  stack_hist->GetXaxis()->SetTitle("met_pt [GeV]");
