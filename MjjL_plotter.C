...
void MjjL_plotter()
{
  ...
  THStack* stack_hist = new THStack("MjjL_stack", "MjjL Histograms");
  ...
  stack_hist->Draw();
  stack_hist->SetName("MjjL plot");
  stack_hist->SetTitle("Plot of MjjL");
  stack_hist->GetXaxis()->SetTitle("MjjL");
