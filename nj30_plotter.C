...
void nj30_plotter()
{
  ...
  THStack* stack_hist = new THStack("nj30_stack", "Amount of nj30 Histograms");
  ...
  stack_hist->Draw();
  stack_hist->SetName("nj30 plot");
  stack_hist->SetTitle("Plot of the number of jets");
  stack_hist->GetXaxis()->SetTitle("# jets");
