...
void lep_pt_2_plotter()
{
  ...
  THStack* stack_hist = new THStack("lep_pt_2_stack", "Second Position Lepton Momentum Histograms");
  ...
  stack_hist->Draw();
  stack_hist->SetName("lep_pt_2 plot");
  stack_hist->SetTitle("Plot of Second Position Lepton Momentum");
