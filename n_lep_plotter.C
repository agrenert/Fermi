...
void n_lep_plotter()
{
  ...
  stack_hist->Draw();
  stack_hist->SetName("n_lep plot");
  stack_hist->SetTitle("Plot of Number of Leptons");
  stack_hist->GetXaxis()->SetTitle("# lep");
